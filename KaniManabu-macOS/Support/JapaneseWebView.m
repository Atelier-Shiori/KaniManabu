...
- (void)loadHTMLFromFrontText:(NSString *)fronttext {
    ...
    NSString *htmltext = [NSString stringWithFormat:@"<html><head><meta charset=\"UTF-8\"><style>.content{display: flex; justify-content: center; align-items: center; text-align: center; min-height: 1vh;font-family: -apple-system, BlinkMacSystemFont, Helvetica, sans-serif, \"Apple Color Emoji\";font-size: 5em;}@media only screen and (max-width: 499px){.content{font-size: 2.5em;}]</style></head><body><div class=\"content\"><p>%@</p></div></body></html>", fronttext];
    [_webView loadHTMLString:htmltext baseURL:nil];
}

- (void)loadHTMLFromFrontText:(NSString *)fronttext withBackText:(NSString *)backtext {
    //Loads back notes
    NSString *htmltext = [NSString stringWithFormat:@"<html><head><meta charset=\"UTF-8\"><style>.content{display: flex; justify-content: center; align-items: center; text-align: center; min-height: 1vh;font-family: -apple-system, BlinkMacSystemFont, Helvetica, sans-serif, \"Apple Color Emoji\";font-size: 5em;}@media only screen and (max-width: 499px){.content{font-size: 2.5em;}]</style></head><body><div class=\"content\"><p>%@</p></div><hr><div class=\"content\"><p>%@</p></div></body></html>", fronttext, backtext];
    [_webView loadHTMLString:htmltext baseURL:nil];
}
@end
